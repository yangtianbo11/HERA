...
// E -> boolean                   // PREDICT = FIRST(boolean) = { "#t", "#f", "#T", "#F" }
...
// E_IN_PARENS -> if E E E        // PREDICT = FIRST(if E E E) = FIRST(if) = { "if" }   // for (if)
// E_IN_PARENS -> let* E E        // PREDICT = FIRST(let* E E) = FIRST(let*) = { "let*" }   // for (let*)
